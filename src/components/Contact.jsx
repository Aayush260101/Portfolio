...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      {
        from_name:form.name,
        to_name:'Aayush Kumar',
        from_email:form.email,
        to_email:'kumar.aayush.20021276@gmail.com',
      ...
      >
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea rows="7" name="message" value={form.message} onChange={handleChange} placeholder='Enter your message' 
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium"/>
          </label>
          <button type="submit"
